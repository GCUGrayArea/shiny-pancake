            ...
            {!loading && !error && totalItems === 0 && (
              <View style={styles.centerContent}>
                ...
                <Text style={styles.noItemsSubtext}>
                  This message uses standard language without cultural
                  references or slang.
                </Text>
              </View>
            )}
                ...
                {culturalHints.length > 0 && (
                  <>
                    ...
                    {culturalHints.map((hint) => (
                      <View
                        key={hint.id}
                        style={[styles.itemCard, styles.culturalCard]}
                      >
                        <View style={styles.itemHeader}>
                          <View
                            style={[styles.categoryBadge, styles.culturalBadge]}
                          >
                            <Text style={styles.categoryIcon}>
                              {getCulturalIcon(hint.category)}
                            </Text>
                            <Text
                              style={[styles.categoryText, styles.culturalText]}
                            >
                ...
                {slangItems.length > 0 && (
                  <>
                    ...
                    {slangItems.map((item) => (
                      <View
                        key={item.id}
                        style={[styles.itemCard, styles.slangCard]}
                      >
                        <View style={styles.itemHeader}>
                          <View
                            style={[styles.categoryBadge, styles.slangBadge]}
                          >
                            <Text style={styles.categoryIcon}>
                              {getSlangIcon(item.category)}
                            </Text>
                            <Text
                              style={[styles.categoryText, styles.slangText]}
                            >
